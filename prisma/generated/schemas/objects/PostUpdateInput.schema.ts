...
import { AuthorUpdateOneRequiredWithoutPostsNestedInputObjectSchema } from './AuthorUpdateOneRequiredWithoutPostsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.PostUpdateInput> = z
  .object({
    ...
    quote: z
      ...
      .nullable(),
    author: z
      .lazy(() => AuthorUpdateOneRequiredWithoutPostsNestedInputObjectSchema)
      .optional(),
  })
  .strict();
